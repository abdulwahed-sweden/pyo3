...
//! # clarax-django
//!
//! High-performance Django integration layer built on ClaraX.
//!
...
/// Usage from Python:
/// ```python
/// schema = clarax_django.ModelSchema(MyModel)
/// result = clarax_django.serialize_instance(instance, schema)
/// ```
#[pyclass]
#[derive(Clone)]
...
/// Returns the clarax-django version string.
#[pyfunction]
...
#[pymodule]
fn clarax_django(m: &Bound<'_, PyModule>) -> PyResult<()> {
