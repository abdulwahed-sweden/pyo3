...
//! clarax-core's `FieldType`. The actual serialization and validation
//! logic lives in clarax-core — this module only handles the mapping.
...
/// for error messages and round-tripping, and converts to clarax-core's
...
impl FieldDescriptor {
    /// Converts this Django descriptor to a clarax-core descriptor.
...
///
/// Each variant maps to a clarax-core `FieldType` via `to_core_type()`.
...
impl DjangoFieldType {
    ...
    /// Converts this Django field type to a clarax-core `FieldType`.
...
// Re-export FieldValue from clarax-core — no Django-specific wrapper needed.
