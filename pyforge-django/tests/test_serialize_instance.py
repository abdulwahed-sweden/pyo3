...
def _can_import_pyforge():
    try:
        import pyforge_django
        return True
    except ImportError:
        return False
...
pytestmark = pytest.mark.skipif(
    not _can_import_pyforge(),
    reason="pyforge_django native extension not installed",
)
...
class TestSerializeInstance(TestCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        from pyforge_django import ModelSchema
    ...
    def test_serialize_basic_instance(self):
        ...
        from pyforge_django import serialize_instance
    ...
    def test_serialize_batch(self):
        ...
        from pyforge_django import serialize_batch
