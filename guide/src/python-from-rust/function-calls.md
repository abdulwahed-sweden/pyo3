...
ClaraX offers two APIs to make function calls:

- [`call`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call) - call any callable Python object.
- [`call_method`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call_method) - call a method on the Python object.
...
- [`call1`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call1) and [`call_method1`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call_method1) to call only with positional `args`.
- [`call0`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call0) and [`call_method0`]({{#PYO3_DOCS_URL}}/clarax/types/trait.PyAnyMethods.html#tymethod.call_method0) to call with no arguments.
...
You can use the [`IntoPyDict`]({{#PYO3_DOCS_URL}}/clarax/types/trait.IntoPyDict.html) trait to convert other dict-like containers, e.g. `HashMap` or `BTreeMap`, as well as tuples with up to 10 elements and `Vec`s where each element is a two-element tuple.
