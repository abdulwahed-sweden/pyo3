...
`clarax-ffi`. They are all tested using `nox` in ClaraX's CI.

Below is a brief description of each of these:

| Example | Description |
| `word-count` | Illustrates how to use clarax-ffi to write a static rust extension |
| `sequential` | Illustrates how to use clarax-ffi to write subinterpreter-safe modules using multi-phase module initialization |
