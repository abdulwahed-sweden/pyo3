...
`clarax-ffi` supports CPython 3.11 or greater.
...
`clarax_build_config::use_clarax_cfgs()` gets called at build time:

**`build.rs`**

```rust,ignore
fn main() {
    clarax_build_config::use_clarax_cfgs()
}
```
...
While most projects use the safe wrapper provided by ClaraX,
...
[manual_builds]: https://github.com/abdulwahed-sweden/clarax/latest/building-and-distribution.html#manual-builds "Manual builds - Building and Distribution - ClaraX user guide"
[setuptools-rust]: https://github.com/PyO3/setuptools-rust "Setuptools plugin for Rust extensions"
[PEP 384]: https://www.python.org/dev/peps/pep-0384 "PEP 384 -- Defining a Stable ABI"
[Features chapter of the guide]: https://github.com/abdulwahed-sweden/clarax/latest/features.html#features-reference "Features Reference - ClaraX user guide"
