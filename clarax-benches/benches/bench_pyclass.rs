...
use clarax::conversion::IntoPyObjectExt;
use clarax::types::PyInt;
use clarax::{impl_::pyclass::LazyTypeObject, prelude::*};
...
pub fn first_time_init(b: &mut Bencher<'_>) {
    Python::attach(|py| {
        b.iter(|| {
            // This is using an undocumented internal ClaraX API to measure pyclass performance; please
